...
Using a mass spectrometer, researchers find a molecule with the sum formula C16H10 in a comet. 
They now want to figure out whether any line in the spectrum of the coma of the parent object corresponds to some molecule with that sum formula. 
Conversely, a researcher may want to find lines of Methane or perhaps even Methane with one hydrogen atom being replaced by a deuteron. 
...
The RESOURCE element \textbf{SHOULD} contain an INFO with
name={\textquotedbl}service\_protocol{\textquotedbl}. 

\begin{lstlisting}{language=XML}
<INFO name="service_protocol" value="SLAP 2.0"/>
\end{lstlisting}
