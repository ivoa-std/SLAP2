...
The \textbf{INCHI} parameter defines an expression using the SQL LIKE syntax 
to search for species by their InChI identifier. The search is case sensitive. 
...
The \textbf{SPECIES} parameter defines an expression using the SQL LIKE syntax to perform
a search in the list of species provided by the service. The search is case-sensitive.

Returns carbon monoxide and carbon dioxide :
\parexample{SPECIES=CO\_}
...
Look for HCN and HCCN molecules, whose formula starts with "HC" and ends with "N" :
\parexample{SPECIES=H[C]+N}
...
The \textbf{STOICHIOMETRIC\_FORMULA} parameter defines an expression using the SQL LIKE syntax to perform
a search in the list of stoichiometric formula provided by the service.The search is case-sensitive.
...
vacuum\_wavelength\_original           & RadTransWavelength                                            & MAY     &  YES  \\
vacuum\_wavelength\_error              & RadTransWavelengthAccuracy                                    & MUST    &  YES  \\
vacuum\_wavelength\_error\_original    & RadTransWavelengthAccuracy                                    & MAY     &  YES  \\
...
lower\_level\_energy\_original         & StateEnergy                                                   & MAY     &  YES  \\
upper\_level\_energy                   & StateEnergy                                                   & MAY     &  YES  \\
upper\_level\_energy\_original         & StateEnergy                                                   & MAY     &  YES  \\
