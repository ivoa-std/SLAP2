...
Exactly one field \textbf{MAY} have name={"chemical\_element\_mass"}, with  datatype={"float"} and ucd={"phys.atmol.element"}. 
...
Exactly one field \textbf{MAY} have name={"lower\_level\_configuration"}, with ucd={"phys.atmol.configuration"}, 
...
Exactly one field \textbf{MAY} have name={"upper\_level\_configuration"}, with ucd={"phys.atmol.configuration"}, 
...
Exactly one field \textbf{MAY} have name={"lower\_state\_quantum\_numbers"} with datatype={"char"} and arraysize={"*"} 
...
Exactly one field \textbf{MAY} have name={"atomicity"}, with  datatype={"int"}. 
