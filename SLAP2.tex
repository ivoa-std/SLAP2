...
At most one field \textbf{MAY} have name={"species\_mass"}, with  datatype={"float"} and ucd=\ucd{"phys.atmol.element"}. 
...
SPECIES              & AtomSymbol, MoleculeChemicalName, MoleculeOrdinaryStructuralFormula \\
INCHIKEY             & InchiKey                            \\
SPECIES\_MASS        & AtomMass, MoleculeMolecularWeight   \\
...
\centering
\small
\begin{tabularx}{\textwidth}{|p{5.5cm}|>{\raggedright\arraybackslash}X|p{2.3cm}|p{1.5cm}|}
\hline
...
vacuum\_wavelength\_error              & RadTransWavelengthAccuracy                                    & MUST    &  YES  \\
line\_title                            & RadTransComment                                               & MUST    &  NO   \\
species\_name                          & AtomSymbol, MoleculeChemicalName                              & MUST    &  NO   \\
species\_mass                          & AtomMass, MoleculeMolecularWeight                             & MAY     &  YES  \\
inchikey                               & AtomInchiKey, MoleculeInchiKey                                & MUST    &  NO   \\
inchi                                  & AtomInchi, MoleculeInchi                                      & MUST    &  NO   \\
ion\_charge                            & AtomIonCharge, MoleculeIonCharge                              & MUST    &  NO   \\
lower\_level\_description              & AtomStateDescription, MoleculeStateDescription                & MUST    &  YES  \\
upper\_level\_description              & AtomStateDescription, MoleculeStateDescription                & MUST    &  YES  \\
observed\_wavelength                   & RadTransWavelength + RadTransWavelengthMethod = observed      & MAY     &  YES  \\
...
INCHI                                 & Inchi                               \\
SPECIES                               & AtomSymbol, MoleculeChemicalName, MoleculeOrdinaryStructuralFormula \\
STOICHIOMETRIC\_FORMULA               & MoleculeStoichiometric\-Formula     \\
...
inchikey                          & AtomInchiKey, MoleculeInchiKey   & MUST     &  NO   \\
inchi                             & AtomInchi, MoleculeInchi         & MUST     &  NO   \\
species\_stoichiometric\_formula  & MoleculeStoichiometricFormula    & MUST     &  YES  \\
