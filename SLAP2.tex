...
Suggested UCDs are given but services are allowed to use other UCDs if more appropriate.
...
A service \textbf{MAY} implement the \textbf{NUMBER\_OF\_ATOMS} parameter to specify the number of atoms in the returned species.
...
Exactly one field \textbf{SHOULD} have name={"ion\_charge"} with datatype={"int"} and ucd=\ucd{"phys.atmol.element;phys.atmol.ionization"}, containing the charge of  the considered chemical species.
...
<VOTABLE version="1.3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<RESOURCE type="results">
		...
		<INFO name="service_ivoid" value="ivo://myvo.org/slap2" />
		<INFO name="service_protocol" value="ivo://ivoa.net/std/SLAP#lines-2.0" />
		<INFO name="publisher" value="myvo.org" />
		...
		<TABLE>
			...
			<FIELD ucd="meta.title;phys.atmol.level" name="lower_level_description" datatype="char" arraysize="*" />
			<FIELD ucd="meta.title;phys.atmol.level" name="upper_level_description" datatype="char" arraysize="*" />
			...
			<FIELD ucd="phys.atmol.element;phys.atmol.ionization" name="ion_charge" datatype="int" />
